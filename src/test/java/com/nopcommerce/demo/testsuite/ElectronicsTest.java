...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Nishit");
        electronicsPage.sendText(electronicsPage.lastName, "Chitaliya");
        electronicsPage.sendText(electronicsPage.emailId, electronicsPage.generateEmailId());
        electronicsPage.select(electronicsPage.date, "3");
        electronicsPage.select(electronicsPage.month, "2");
        electronicsPage.select(electronicsPage.year, "1993");
        electronicsPage.sendText(electronicsPage.password, "Nishit8664");
        electronicsPage.sendText(electronicsPage.confirmPassword, "Nishit8664");
        //2.21 Click on “REGISTER” Button
        ...
        electronicsPage.sendText(electronicsPage.cityName, "Suray");
        electronicsPage.sendText(electronicsPage.address1, "A 3/4");
        electronicsPage.sendText(electronicsPage.postalCode, "395004");
        electronicsPage.sendText(electronicsPage.phoneNumber, "07424314233");
        //2.28 Click on “CONTINUE”
        ...
        //2.33 Fill all the details
        electronicsPage.sendText(electronicsPage.cardHolderName, "Nishit CHitaliya");
